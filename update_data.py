...
# === 核心升級：全市場 ETF 配息頻率智能判定引擎 ===
def get_etf_freq(ticker, name):
    # 1. 槓桿、反向、期貨、大宗商品型通常不配息
    if any(k in name for k in ['正2', '反1', 'VIX', '原油', '黃金', '白銀', '大豆', '銅', '期貨']):
        return "-"
    ...
    freq_map = {
        ...
        "00940": "月配", "00944": "月配", "00946": "月配", "00893": "月配",
        "00772B": "月配", "00773B": "月配", "00933B": "月配", "00937B": "月配",
        "00942B": "月配", "00945B": "月配", "00948B": "月配", "00953B": "月配",
        "00957B": "月配", "00958B": "月配", "00959B": "月配", "00965B": "月配",
        "00966B": "月配",
        ...
        "00915": "季配", "00918": "季配", "00731": "季配", "00888": "季配",
        "00900": "季配", "00908": "季配", "00909": "季配", "00912": "季配",
        "00922": "季配", "00923": "季配", "00927": "季配", "00928": "季配",
        "00930": "季配", "00932": "季配", "00943": "季配", "00947": "季配",
        "00935": "季配", "00896": "季配", "00894": "季配", "00881": "季配",
        "00720B": "季配", "00751B": "季配", "00725B": "季配", "00782B": "季配",
        "00758B": "季配", "00761B": "季配", "00724B": "季配", "00740B": "季配",
        "00746B": "季配", "00754B": "季配", "00756B": "季配", "00780B": "季配",
        "00789B": "季配", "00795B": "季配", "00836B": "季配", "00842B": "季配",
        "00844B": "季配", "00846B": "季配", "00862B": "季配", "00867B": "季配",
        "00883B": "季配", "00890B": "季配", "00931B": "季配", "00710B": "季配",
        "00711B": "季配", "00718B": "季配", "00721B": "季配", "00722B": "季配",
        "00726B": "季配", "00727B": "季配", "00741B": "季配", "00747B": "季配",
        "00748B": "季配", "00749B": "季配", "00750B": "季配", "00755B": "季配",
        "00760B": "季配", "00764B": "季配", "00768B": "季配", "00775B": "季配",
        "00777B": "季配", "00778B": "季配", "00779B": "季配", "00784B": "季配",
        "00785B": "季配", "00786B": "季配", "00787B": "季配", "00788B": "季配",
        "00791B": "季配", "00792B": "季配", "00793B": "季配", "00794B": "季配",
        "00799B": "季配", "00840B": "季配", "00841B": "季配", "00847B": "季配",
        "00848B": "季配", "00849B": "季配", "00853B": "季配", "00856B": "季配",
        "00857B": "季配", "00859B": "季配", "00860B": "季配",
        
        # 半年配
        "0050": "半年配", "006208": "半年配", "00692": "半年配", "00850": "半年配",
        "0052": "半年配", "0053": "半年配", "006203": "半年配", "006204": "半年配",
        "00690": "半年配", "00701": "半年配", "00728": "半年配", "00730": "半年配",
        "00733": "半年配", "00876": "半年配", "00891": "半年配", "00892": "半年配",
        "00904": "半年配", "00905": "半年配", "00913": "半年配", "00921": "半年配",
        "00924": "半年配", "00687B": "半年配", "00719B": "半年配", "00774B": "半年配",
        "00796B": "半年配",
        
        # 年配
        "0051": "年配", "0055": "年配", "0057": "年配", "0061": "年配",
        "006205": "年配", "00646": "年配", "00662": "年配", "00708": "年配",
        "00851": "年配", "00852": "年配", "00861": "年配", "00875": "年配",
        "00882": "年配", "00889": "年配"
    }
    
    # 3. 匹配與防漏網邏輯
    if ticker in freq_map:
        return freq_map[ticker]
    elif any(k in name for k in ['債', '高息', '優息', '不動產']):
        # 新掛牌沒被寫進名單的債券或高股息，市場主流機率為季配
        return "季配"
    else:
        # 其他未歸類老牌或無配息機制標的
        return "-"
...
def main():
    ...
    for idx, (ticker_id, info) in enumerate(tickers.items()):
        ...
        # 呼叫智能判定引擎取得配息頻率
        freq = get_etf_freq(ticker_id, name)
